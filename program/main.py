...
def apresenteSe ():
    ...
    print('|                                                             |')
    print('|                                                             |')
    print('| Versão 1.0 de 29/abril/2024                                 |')
    print('|                                                             |')
    print('+-------------------------------------------------------------+')
...
def connectar() -> bool:
    ...
    try:
        ...
        connection = pyodbc.connect(
            ...
            database = "BD24339", #banco de dados
            uid = "BD24339", #LOGIN
            pwd = "BD24339" #SENHA
        ) # xxxxx é seu RA
        return True
...
def procurar ():
    ...
    resposta=umTexto('Esse é o contato que você deseja? ','Você deve digitar S ou N',['s','S','n','N'])

    if resposta in ['s','S']:
        print('Contato encontrado com sucesso!')
    else:
        print('Falha ao procurar contato.Tente novamente!')
